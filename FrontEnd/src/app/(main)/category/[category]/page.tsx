...
export default function CategoryPage() {
  ...
  const [selectedCategory, setSelectedCategory] = useState(decodeURIComponent(category as string));
      ...
      <div className="flex-1">
        <div className="w-full mb-6">
          <div className="flex items-center justify-between flex-wrap gap-2">
            <h1 className="text-lg md:text-2xl font-bold capitalize">{selectedCategory}</h1>
