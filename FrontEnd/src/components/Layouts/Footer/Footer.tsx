        ...
        <div className="bg-gray-100 pt-20 mt-40 font-sans">
            ...
            <div className="w-[90%] max-w-[1200px] mx-auto py-10 text-gray-700">
                <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-5 gap-6">
                    ...
                    <div className="col-span-2 sm:col-span-2 lg:col-span-1">
                        <Image src="/images/SHOP.CO.png" alt="shop.co logo" width={167} height={23} />
                        ...
                        <ul className="flex gap-3 mt-3">
                            ...
                            <Image src="/images/github.png" alt="github" width={28} height={28} />
                        </ul>
                    </div>
            ...
            <div className="w-[90%] max-w-[1200px] mx-auto border-t border-gray-200 text-sm text-gray-500 py-6 flex flex-col items-center text-center md:flex-row md:justify-between md:text-left md:items-center gap-4">
                ...
                <div className="flex gap-2 flex-wrap justify-center">
                    <Image src="/images/visa.png" alt="Visa" width={46.61} height={30.03} />
                    <Image src="/images/mastercard.png" alt="MasterCard" width={46.61} height={30.03} />
                    <Image src="/images/paypal.png" alt="PayPal" width={46.61} height={30.03} />
                    <Image src="/images/applepay.png" alt="ApplePay" width={46.61} height={30.03} />
                    <Image src="/images/googlepay.png" alt="GooglePay" width={46.61} height={30.03} />
                </div>
            </div>
